<?php
include("src/MessageDefinition.php");
include("src/Contracts/IsoMessageContract.php");

// use IsoMessageContract;
...
class ExampleMessage extends MessageDefinition implements IsoMessageContract
{
    public function getIso(): array
    {
        return [
            ...
            59  => ['ans', 3,  self::VARIABLE_LENGTH],
            60  => ['ans', 3,  self::VARIABLE_LENGTH],
            61  => ['ans', 20, self::VARIABLE_LENGTH],
